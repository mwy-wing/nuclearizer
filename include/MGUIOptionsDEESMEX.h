...
#ifndef __MGUIOptionsDEESMEX__
#define __MGUIOptionsDEESMEX__
...
class MGUIOptionsDEESMEX : public MGUIOptions
{
  // public Session:
 public:
  //! Default constructor
  MGUIOptionsDEESMEX(MModule* Module);
  //! Default destructor
  virtual ~MGUIOptionsDEESMEX();
